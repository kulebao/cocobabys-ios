...
#define PROJECTCELL         0
#define PROJECTCELL_LAN     1
#define PROJECTCELL_WIFI    2
#define PROJECTCELL_ALARM   3
...
#define kAUDIO_DATA_BUFFER_MAXLENGTH        200   //320 音频队列最大长度，超过这个长度，有可能被直接抛弃
...
#define SettingListShow                     0            //列表显示
#define SettingSnapshotShow                 1            //快照显示
#define SettingMapShow                      2            //地图显示
