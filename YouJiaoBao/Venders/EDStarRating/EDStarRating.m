...
-(void)setDefaultProperties
{
    ...
    starImage = [[UIImage imageNamed:@"EDStarRating.bundle/star-template.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    starHighlightedImage = [[UIImage imageNamed:@"EDStarRating.bundle/star-highlighted-template.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
}
#if  EDSTAR_MACOSX
